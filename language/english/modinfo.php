...
define('_MI_XMDOC_PREF_GENERALUSELIST', 'Show documents as a list');
define('_MI_XMDOC_PREF_GENERALUSELIST_DESC', 'Documents will be displayed as a list. By default they are displayed as thumbnails');
define('_MI_XMDOC_PREF_GENERALLOGOSIZE', 'Logo width in pixels');
define('_MI_XMDOC_PREF_GENERALLOGOSIZE_DESC', 'Only valid for list view');
